...
using Aron.GradientMiner.Data;
using Microsoft.AspNetCore.Identity;
using Aron.GradientMiner.Jobs;
using Aron.GradientMiner.Services;
using Aron.GradientMiner.Helpers;
...
namespace Aron.GradientMiner.Extensions
{
    public static class ServiceExtrensions
    {
        ...
        {
            if (Environment.GetEnvironmentVariables().Contains("GR_USER"))
            {
                appConfig.UserName = Environment.GetEnvironmentVariable("GR_USER").ToString();
            }

            if (Environment.GetEnvironmentVariables().Contains("GR_PASS"))
            {
                appConfig.Password = Environment.GetEnvironmentVariable("GR_PASS").ToString();
            }
